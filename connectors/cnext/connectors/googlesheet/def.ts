  ...
  auth: {
    ...
    scopes: [
      ...
      },
      {
        ...
        description:
          'Provides read/write access only to the currently opened Google Sheet. This is the most restrictive scope, limiting access to a single spreadsheet at a time.',
      },
    ],
  },
