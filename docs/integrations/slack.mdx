...
const slackConfig = {
  ...
  // OpenInt manages the OAuth flow for you.
};
```
...
## Sample OAuth2 Handshake

```bash
# Step 1: Redirect the user for consent:
https://slack.com/oauth/v2/authorize?client_id=<YOUR_CLIENT_ID>&scope=users:read&redirect_uri=<YOUR_REDIRECT_URI>
