---
openapi: https://raw.githubusercontent.com/openintegrations/openSDKs/refs/heads/main/sdks/sdk-airbyte/airbyte_health_v1.oas.json
---
...
```typescript
    ...
    // Health Check
    const res = await airbyte.GET('/health')
```
