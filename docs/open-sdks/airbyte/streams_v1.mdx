---
openapi: https://raw.githubusercontent.com/openintegrations/openSDKs/refs/heads/main/sdks/sdk-airbyte/airbyte_streams_v1.oas.json
---
...
|--------|------|-------------|
| **GET** | /streams | Get stream properties
...
```typescript
    ...
    const res = await airbyte.GET('/streams')
```
