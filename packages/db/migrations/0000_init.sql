...
CREATE TABLE IF NOT EXISTS "public"."connection" (
  ...
  CONSTRAINT "fk_integration_id" FOREIGN KEY ("integration_id") REFERENCES "public"."integration" ("id") ON DELETE RESTRICT,
  CONSTRAINT "fk_institution_id" FOREIGN KEY ("institution_id") REFERENCES "public"."institution" ("id") ON DELETE RESTRICT
);
...
CREATE TABLE IF NOT EXISTS "public"."pipeline" (
  ...
  CONSTRAINT "fk_source_id" FOREIGN KEY ("source_id") REFERENCES "public"."connection" ("id") ON DELETE CASCADE,
  CONSTRAINT "fk_destination_id" FOREIGN KEY ("destination_id") REFERENCES "public"."connection" ("id") ON DELETE CASCADE
);
...
RENAME COLUMN "ledger_id" TO "creator_id";
...
CREATE
OR REPLACE FUNCTION public._uid () RETURNS varchar LANGUAGE sql STABLE AS $function$
  select
...
--> statement-breakpoint
CREATE
OR REPLACE FUNCTION auth.uid () RETURNS varchar LANGUAGE sql STABLE AS $function$
  select public._uid()
$function$;

--> statement-breakpoint
CREATE
OR REPLACE FUNCTION auth.connection_ids () RETURNS VARCHAR[] LANGUAGE sql STABLE AS $function$
...
--> statement-breakpoint
CREATE POLICY "creator_access" ON "public"."connection" USING (creator_id = auth.uid ())
WITH
...
--> statement-breakpoint
CREATE POLICY "connection_creator_access" ON "public"."pipeline" USING (
  "source_id" = ANY (auth.connection_ids ())
  OR "destination_id" = ANY (auth.connection_ids ())
)
WITH
  CHECK (
    "source_id" = ANY (auth.connection_ids ())
...
CREATE POLICY "public_readable" ON public.institution FOR
SELECT
  USING (TRUE);
...
ADD COLUMN "ledger_connection_id" VARCHAR;

--> statement-breakpoint -- How do we make this non-null?
ALTER TABLE "public"."transaction"
ADD CONSTRAINT "fk_transaction_ledger_connection_id" FOREIGN KEY ("ledger_connection_id") REFERENCES "public"."connection" ("id") ON DELETE CASCADE;
...
--> statement-breakpoint
CREATE POLICY "ledger_connection_creator_access" ON "public"."transaction" USING (ledger_connection_id = ANY (auth.connection_ids ()))
WITH
  CHECK (ledger_connection_id = ANY (auth.connection_ids ()));
...
--> statement-breakpoint
ALTER TABLE "public"."account"
ADD CONSTRAINT "fk_account_ledger_connection_id" FOREIGN KEY ("ledger_connection_id") REFERENCES "public"."connection" ("id") ON DELETE CASCADE;
...
--> statement-breakpoint
CREATE POLICY "ledger_connection_creator_access" ON "public"."account" USING (ledger_connection_id = ANY (auth.connection_ids ()))
WITH
  CHECK (ledger_connection_id = ANY (auth.connection_ids ()));
...
--> statement-breakpoint
ALTER TABLE "public"."commodity"
ADD CONSTRAINT "fk_commodity_ledger_connection_id" FOREIGN KEY ("ledger_connection_id") REFERENCES "public"."connection" ("id") ON DELETE CASCADE;
...
--> statement-breakpoint
CREATE POLICY "ledger_connection_creator_access" ON "public"."commodity" USING (ledger_connection_id = ANY (auth.connection_ids ()))
WITH
  CHECK (ledger_connection_id = ANY (auth.connection_ids ()));
...
ALTER TABLE "public"."transaction"
RENAME TO "raw_transaction";

--> statement-breakpoint
ALTER TABLE "public"."account"
RENAME TO "raw_account";

--> statement-breakpoint
ALTER TABLE "public"."commodity"
RENAME TO "raw_commodity";
...
RENAME CONSTRAINT pk_connection TO pk_resource;

--> statement-breakpoint
ALTER INDEX connection_created_at
RENAME TO resource_created_at;

--> statement-breakpoint
ALTER INDEX connection_updated_at
RENAME TO resource_updated_at;

--> statement-breakpoint
ALTER INDEX connection_provider_name
RENAME TO resource_provider_name;

--> statement-breakpoint
ALTER INDEX connection_creator_id
RENAME TO resource_creator_id;

--> statement-breakpoint
ALTER POLICY connection_creator_access ON public.pipeline
RENAME TO resource_creator_access;

--> statement-breakpoint
ALTER TABLE "public"."pipeline"
DROP CONSTRAINT fk_destination_id,
ADD CONSTRAINT "fk_destination_id" FOREIGN KEY ("destination_id") REFERENCES "public"."resource" ("id") ON DELETE CASCADE ON UPDATE CASCADE;

--> statement-breakpoint
ALTER TABLE "public"."pipeline"
DROP CONSTRAINT fk_source_id,
ADD CONSTRAINT "fk_source_id" FOREIGN KEY ("source_id") REFERENCES "public"."resource" ("id") ON DELETE CASCADE ON UPDATE CASCADE;

--> statement-breakpoint
--- Data table update
ALTER TABLE "public"."raw_transaction"
RENAME COLUMN "ledger_connection_id" TO "ledger_resource_id";
...
--> statement-breakpoint
ALTER TABLE "public"."raw_account"
DROP CONSTRAINT fk_account_ledger_connection_id,
ADD CONSTRAINT "fk_account_ledger_connection_id" FOREIGN KEY ("ledger_resource_id") REFERENCES "public"."resource" ("id") ON DELETE CASCADE ON UPDATE CASCADE;

--> statement-breakpoint
ALTER TABLE "public"."raw_transaction"
DROP CONSTRAINT fk_transaction_ledger_connection_id,
ADD CONSTRAINT "fk_transaction_ledger_connection_id" FOREIGN KEY ("ledger_resource_id") REFERENCES "public"."resource" ("id") ON DELETE CASCADE ON UPDATE CASCADE;

--> statement-breakpoint
ALTER TABLE "public"."raw_commodity"
DROP CONSTRAINT fk_commodity_ledger_connection_id,
ADD CONSTRAINT "fk_commodity_ledger_connection_id" FOREIGN KEY ("ledger_resource_id") REFERENCES "public"."resource" ("id") ON DELETE CASCADE ON UPDATE CASCADE;

--> statement-breakpoint
ALTER POLICY ledger_connection_creator_access ON public.raw_transaction
RENAME TO ledger_resource_creator_access;

--> statement-breakpoint
ALTER POLICY ledger_connection_creator_access ON public.raw_account
RENAME TO ledger_resource_creator_access;

--> statement-breakpoint
ALTER POLICY ledger_connection_creator_access ON public.raw_commodity
RENAME TO ledger_resource_creator_access;

--> statement-breakpoint
--- RLS update
ALTER FUNCTION auth.connection_ids
RENAME TO resource_ids;

--> statement-breakpoint
CREATE
OR REPLACE FUNCTION auth.resource_ids () RETURNS CHARACTER VARYING[] LANGUAGE sql STABLE AS $function$
...
UPDATE resource
SET
  id = 'reso_' || SUBSTRING(id, 6)
WHERE
  starts_with(id, 'conn_');

--> statement-breakpoint
UPDATE raw_account
SET
  source_id = 'reso_' || SUBSTRING(source_id, 6)
WHERE
  starts_with(source_id, 'conn_');
...
comment ON CONSTRAINT fk_source_id ON "pipeline" IS E'@graphql({"foreign_name": "source", "local_name": "sourceOfPipelines"})';

--> statement-breakpoint
comment ON CONSTRAINT fk_destination_id ON "pipeline" IS E'@graphql({"foreign_name": "destination", "local_name": "destinationOfPipelines"})';

--> statement-breakpoint
--- filename: 2023-02-22_institution_rls.sql ---
CREATE
OR REPLACE FUNCTION auth.institution_ids () RETURNS CHARACTER VARYING[] LANGUAGE sql STABLE AS $function$
  select array(
...
--> statement-breakpoint
CREATE POLICY "connection_creator_access" ON "public"."institution" USING ("id" = ANY (auth.institution_ids ()))
WITH
  CHECK ("id" = ANY (auth.institution_ids ()));
...
--> statement-breakpoint
CREATE
OR REPLACE procedure auth.login_as_anon () language plpgsql AS $$
begin
...
--> statement-breakpoint
CREATE
OR REPLACE procedure auth.logout () language plpgsql AS $$
begin
    set request.jwt.claim.sub='';
    set request.jwt.claim.role='';
    set request.jwt.claim.email='';
...
CREATE
OR REPLACE procedure auth.set_user_admin (user_email text, admin boolean) language plpgsql AS $$
declare
    auth_user record;
begin
	UPDATE
...
CREATE
OR REPLACE FUNCTION auth.is_admin () RETURNS boolean LANGUAGE sql STABLE AS $function$
...
CREATE
OR REPLACE FUNCTION auth.pre_request () RETURNS void AS $$
  select set_config(
...
--> statement-breakpoint
CREATE
OR REPLACE FUNCTION auth.resource_ids () RETURNS CHARACTER VARYING[] LANGUAGE sql stable AS $$
  select
...
*/
ALTER TABLE "public"."resource"
RENAME COLUMN "creator_id" TO "end_user_id";

--> statement-breakpoint
ALTER POLICY creator_access ON public.resource
RENAME TO end_user_access;

--> statement-breakpoint
ALTER POLICY resource_creator_access ON public.pipeline
RENAME TO end_user_access;

--> statement-breakpoint
ALTER POLICY connection_creator_access ON public.institution
RENAME TO end_user_access;
...
ALTER TABLE "public"."raw_transaction"
ADD COLUMN "end_user_id" varchar;
...
--> statement-breakpoint
UPDATE "public"."raw_transaction"
SET
  end_user_id = REPLACE(ledger_resource_id, 'reso_postgres_', '');

--> statement-breakpoint
UPDATE "public"."raw_account"
SET
  end_user_id = REPLACE(ledger_resource_id, 'reso_postgres_', '');

--> statement-breakpoint
UPDATE "public"."raw_commodity"
SET
  end_user_id = REPLACE(ledger_resource_id, 'reso_postgres_', '');
...
--> statement-breakpoint
CREATE POLICY end_user_access ON public.raw_transaction USING (end_user_id = auth.uid ())
WITH
  CHECK (end_user_id = auth.uid ());

--> statement-breakpoint
DROP POLICY IF EXISTS ledger_resource_creator_access ON public.raw_account;

--> statement-breakpoint
CREATE POLICY end_user_access ON public.raw_account USING (end_user_id = auth.uid ())
WITH
  CHECK (end_user_id = auth.uid ());
...
--> statement-breakpoint
CREATE POLICY end_user_access ON public.raw_commodity USING (end_user_id = auth.uid ())
WITH
  CHECK (end_user_id = auth.uid ());
...
ALTER TABLE "public"."raw_transaction"
DROP COLUMN "ledger_resource_id" CASCADE;
...
--> statement-breakpoint
CREATE
OR REPLACE FUNCTION auth.institution_ids () RETURNS CHARACTER VARYING[] LANGUAGE sql STABLE AS $$
  select array(
    SELECT DISTINCT institution_id FROM "resource"
...
--> statement-breakpoint
ALTER INDEX resource_creator_id
RENAME TO resource_end_user_id;
...
--> statement-breakpoint
CREATE POLICY end_user_access ON public.resource USING (
  (
    WITH
...
--> statement-breakpoint
CREATE POLICY end_user_access ON "public"."pipeline" USING (
  (
    WITH
      cached AS MATERIALIZED (
        SELECT
...
--> statement-breakpoint
CREATE POLICY public_readonly_access ON "public"."institution" FOR
SELECT
  USING (TRUE);
...
--> statement-breakpoint
CREATE POLICY end_user_access ON public.raw_transaction USING (
  (
    WITH
      cached AS MATERIALIZED (
        SELECT
...
--> statement-breakpoint
CREATE POLICY end_user_access ON public.raw_account USING (
  (
    WITH
      cached AS MATERIALIZED (
        SELECT
...
--> statement-breakpoint
CREATE POLICY end_user_access ON public.raw_commodity USING (
  (
    WITH
      cached AS MATERIALIZED (
        SELECT
...
--> statement-breakpoint
ALTER TABLE "public"."integration"
ADD COLUMN end_user_access boolean;
...
CREATE
OR REPLACE FUNCTION jwt_sub () RETURNS varchar LANGUAGE sql STABLE AS $function$
  select coalesce(
    nullif(current_setting('request.jwt.claim.sub', true), ''),
    (nullif(current_setting('request.jwt.claims', true), '')::jsonb ->> 'sub')
  )
...
--> statement-breakpoint
CREATE
OR REPLACE FUNCTION jwt_org_id () RETURNS varchar LANGUAGE sql STABLE AS $function$
  select coalesce(
...
--> statement-breakpoint
CREATE
OR REPLACE FUNCTION jwt_end_user_id () RETURNS varchar LANGUAGE sql STABLE AS $function$
  select coalesce(
...
--> statement-breakpoint
CREATE POLICY org_member_access ON "public"."integration" TO authenticated USING (org_id = jwt_org_id ())
WITH
  CHECK (org_id = jwt_org_id ());

--> statement-breakpoint
DROP POLICY IF EXISTS org_member_access ON public.resource;

--> statement-breakpoint
CREATE POLICY org_member_access ON "public"."resource" TO authenticated USING (
  integration_id = ANY (
    SELECT
      id
    FROM
...
--> statement-breakpoint
CREATE POLICY org_member_access ON "public"."pipeline" TO authenticated USING (
  array(
    SELECT
      r.id
    FROM
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT FROM pg_catalog.pg_roles WHERE rolname = 'end_user') THEN
    CREATE ROLE "end_user" WITH PASSWORD 'thex0hDD123b1!';
  ELSE
    RAISE NOTICE 'Role "end_user" already exists. Skipping creation.';
  END IF;
EXCEPTION
  WHEN OTHERS THEN
    RAISE NOTICE 'Failed to create end_user role: %', SQLERRM;
END
$$;

--> statement-breakpoint-- Irrelevant pw work around neon, no login allowed
GRANT "end_user" TO CURRENT_USER;

--> statement-breakpoint -- "postgres" -- CURRENT_USER
...
GRANT
SELECT
  ON public.institution TO "end_user";

--> statement-breakpoint
GRANT
SELECT
  (id, org_id) ON public.integration TO "end_user";

--> statement-breakpoint
DROP POLICY IF EXISTS end_user_access ON public.integration;

--> statement-breakpoint
CREATE POLICY end_user_access ON public.integration TO end_user USING (
  org_id = jwt_org_id ()
  AND end_user_access = TRUE
);
...
,
UPDATE (display_name),
DELETE ON public.resource TO "end_user";

--> statement-breakpoint
DROP POLICY IF EXISTS end_user_access ON public.resource;

--> statement-breakpoint
CREATE POLICY end_user_access ON public.resource TO end_user USING (
  integration_id = ANY (
    SELECT
      id
    FROM
...
GRANT
SELECT
  ON public.pipeline TO "end_user";

--> statement-breakpoint
DROP POLICY IF EXISTS end_user_access ON public.pipeline;

--> statement-breakpoint
CREATE POLICY end_user_access ON public.pipeline TO end_user USING (
  (
    SELECT
      array(
        SELECT
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_roles WHERE rolname = 'org') THEN
    CREATE ROLE "org" WITH PASSWORD 'thex0hDD123b1!';
  ELSE
    RAISE NOTICE 'Role "org" already exists, skipping creation';
  END IF;
END
$$;

--> statement-breakpoint -- Irrelevant pw, no login allowed
GRANT "org" TO CURRENT_USER;

--> statement-breakpoint --  "postgres"; --> statement-breakpoint -- CURRENT_USER
GRANT "end_user" TO "authenticator";
...
,
  INSERT,
UPDATE,
DELETE ON ALL TABLES IN SCHEMA public TO "org";

--> statement-breakpoint
DROP POLICY IF EXISTS org_access ON public.integration;

--> statement-breakpoint
CREATE POLICY org_access ON public.integration TO org USING (org_id = jwt_org_id ())
WITH
  CHECK (org_id = jwt_org_id ());
...
--> statement-breakpoint
CREATE POLICY org_access ON public.resource TO org USING (
  integration_id = ANY (
    SELECT
      id
    FROM
...
--> statement-breakpoint
CREATE POLICY org_access ON public.pipeline TO org USING (
  (
    SELECT
      array(
        SELECT
...
GRANT INSERT,
UPDATE ON public.institution TO "org";

--> statement-breakpoint
DROP POLICY IF EXISTS org_write_access ON public.institution;

--> statement-breakpoint
CREATE POLICY org_write_access ON "public"."institution" FOR ALL USING (TRUE)
WITH
  CHECK (TRUE);
...
SELECT
  ...
  i.display_name,
  i.end_user_access,
  (i.config - 'secrets') || jsonb_build_object('clientSecret', s.value, 'envName', s.key) AS newconfig
  --     s.key,
  --     s.value
FROM
  integration i,
  LATERAL jsonb_each(i.config -> 'secrets'::text) s (KEY, value)
WHERE
  i.provider_name = 'plaid'
  AND s.key != 'sandbox';

--> statement-breakpoint
-- For reals --
INSERT INTO
  integration (id, org_id, display_name, end_user_access, config)
SELECT
  concat('int_plaid_', generate_ulid ()),
  i.org_id,
  i.display_name,
  i.end_user_access,
  (i.config - 'secrets') || jsonb_build_object('clientSecret', s.value, 'envName', s.key)
FROM
  integration i,
  LATERAL jsonb_each(i.config -> 'secrets'::text) s (KEY, value)
WHERE
...
UPDATE integration
SET
  config = (config - 'secrets') || jsonb_build_object('clientSecret', config -> 'secrets' -> 'sandbox', 'envName', 'sandbox')
WHERE
  config -> 'secrets' -> 'sandbox' IS NOT NULL;
...
ADD COLUMN env_name varchar GENERATED ALWAYS AS (config ->> 'envName') STORED;

--> statement-breakpoint
GRANT
SELECT
  (env_name, display_name) ON TABLE public.integration TO end_user;

--> statement-breakpoint
--- filename: 2023-10-29_2125_integration_provider_name_grant.sql ---
GRANT
SELECT
  (provider_name) ON TABLE public.integration TO end_user;
...
RENAME COLUMN provider_name TO connector_name;
...
-- Unrelated
ALTER TABLE resource
DROP CONSTRAINT fk_institution_id;

--> statement-breakpoint
ALTER TABLE resource
ADD CONSTRAINT "fk_institution_id" FOREIGN KEY ("institution_id") REFERENCES "public"."institution" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;

--> statement-breakpoint
-- Drop constraints rename and re-add constraints
ALTER TABLE resource
DROP CONSTRAINT fk_integration_id;

--> statement-breakpoint
ALTER TABLE integration
DROP CONSTRAINT integration_id_prefix_check;

--> statement-breakpoint
ALTER TABLE integration
RENAME TO connector_config;

--> statement-breakpoint
ALTER TABLE resource
RENAME COLUMN integration_id TO connector_config_id;

--> statement-breakpoint
ALTER TABLE resource
ADD CONSTRAINT "fk_connector_config_id" FOREIGN KEY ("connector_config_id") REFERENCES "public"."connector_config" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;

--> statement-breakpoint
UPDATE connector_config
SET
  id = REPLACE(id, 'int_', 'ccfg_');

--> statement-breakpoint
ALTER TABLE connector_config
ALTER COLUMN id
SET DEFAULT concat('ccfg_', public.generate_ulid ()),
...
--> statement-breakpoint
ALTER TABLE institution
DROP CONSTRAINT institution_id_prefix_check;
...
--> statement-breakpoint
ALTER TABLE resource
RENAME COLUMN institution_id TO integration_id;

--> statement-breakpoint
ALTER TABLE resource
ADD CONSTRAINT "fk_integration_id" FOREIGN KEY ("integration_id") REFERENCES "public"."integration" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;

--> statement-breakpoint
UPDATE integration
SET
  id = CONCAT('int_', SUBSTRING(id, LENGTH('ins_') + 1));
...
ALTER TABLE connector_config
ADD COLUMN default_destination_id varchar GENERATED ALWAYS AS (config ->> 'default_destination_id') STORED;

--> statement-breakpoint
ALTER TABLE connector_config
ADD CONSTRAINT "fk_default_destination_id" FOREIGN KEY ("default_destination_id") REFERENCES "public"."resource" ("id") ON DELETE RESTRICT ON UPDATE RESTRICT;

--> statement-breakpoint
ALTER TABLE connector_config
ADD COLUMN default_source_id varchar GENERATED ALWAYS AS (config ->> 'default_source_id') STORED;

--> statement-breakpoint
ALTER TABLE connector_config
ADD CONSTRAINT "fk_default_source_id" FOREIGN KEY ("default_source_id") REFERENCES "public"."resource" ("id") ON DELETE RESTRICT ON UPDATE RESTRICT;
...
ALTER TABLE connector_config
DROP CONSTRAINT "fk_default_source_id";

--> statement-breakpoint
ALTER TABLE connector_config
DROP CONSTRAINT "fk_default_destination_id";

--> statement-breakpoint
ALTER TABLE connector_config
DROP COLUMN default_source_id;
...
--> statement-breakpoint
ALTER TABLE connector_config
ADD COLUMN default_destination_id varchar;

--> statement-breakpoint
ALTER TABLE connector_config
ADD CONSTRAINT "fk_default_destination_id" FOREIGN KEY ("default_destination_id") REFERENCES "public"."resource" ("id") ON DELETE SET NULL ON UPDATE CASCADE;

--> statement-breakpoint
ALTER TABLE connector_config
ADD COLUMN default_source_id varchar;

--> statement-breakpoint
ALTER TABLE connector_config
ADD CONSTRAINT "fk_default_source_id" FOREIGN KEY ("default_source_id") REFERENCES "public"."resource" ("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
--> statement-breakpoint
ALTER TABLE connector_config
ADD COLUMN default_pipe_out jsonb;

--> statement-breakpoint
ALTER TABLE connector_config
ADD COLUMN default_pipe_in jsonb;

--> statement-breakpoint
ALTER TABLE connector_config
ADD COLUMN default_pipe_out_destination_id varchar GENERATED ALWAYS AS (default_pipe_out ->> 'destination_id') STORED;

--> statement-breakpoint
ALTER TABLE connector_config
ADD CONSTRAINT "fk_default_pipe_out_destination_id" FOREIGN KEY ("default_pipe_out_destination_id") REFERENCES "public"."resource" ("id") ON DELETE RESTRICT ON UPDATE RESTRICT;

--> statement-breakpoint
ALTER TABLE connector_config
ADD COLUMN default_pipe_in_source_id varchar GENERATED ALWAYS AS (default_pipe_in ->> 'source_id') STORED;

--> statement-breakpoint
ALTER TABLE connector_config
ADD CONSTRAINT "fk_default_pipe_in_source_id" FOREIGN KEY ("default_pipe_in_source_id") REFERENCES "public"."resource" ("id") ON DELETE RESTRICT ON UPDATE RESTRICT;
...
--> statement-breakpoint
CREATE POLICY end_user_access ON public.connector_config TO end_user USING (org_id = jwt_org_id ());

--> statement-breakpoint
ALTER TABLE connector_config
DROP COLUMN end_user_access;
...
--> statement-breakpoint
CREATE
OR REPLACE procedure auth.login_as (role_name text, sub text) language plpgsql AS $$
declare
    auth_user record;
begin
...
--> statement-breakpoint
CREATE
OR REPLACE procedure auth.login_as_user (sub text, org_id text) language plpgsql AS $$
declare
    auth_user record;
begin
...
--> statement-breakpoint
CREATE
OR REPLACE procedure auth.login_as_end_user (sub text, org_id text) language plpgsql AS $$
declare
    auth_user record;
begin
...
--> statement-breakpoint
CREATE
OR REPLACE procedure auth.login_as_org (sub text) language plpgsql AS $$
declare
    auth_user record;
begin
...
ALTER TABLE pipeline
ADD COLUMN source_vertical varchar;

--> statement-breakpoint
ALTER TABLE pipeline
ADD COLUMN destination_vertical varchar;

--> statement-breakpoint
--- filename: 2024-09-26_1612_connector_config_disabled.sql ---
GRANT
SELECT
  (disabled) ON TABLE public.connector_config TO end_user;
...
--> statement-breakpoint
ALTER POLICY end_user_access ON public.connector_config
RENAME TO customer_access;

--> statement-breakpoint
ALTER POLICY end_user_access ON public.pipeline
RENAME TO customer_access;

--> statement-breakpoint
ALTER POLICY end_user_access ON public.resource
RENAME TO customer_access;

--> statement-breakpoint
-- 2. Rename the function
ALTER FUNCTION public.jwt_end_user_id
RENAME TO jwt_customer_id;

--> statement-breakpoint
-- 3. Rename column in resource table
ALTER TABLE public.resource
RENAME COLUMN end_user_id TO customer_id;

--> statement-breakpoint
-- 4. Rename index
ALTER INDEX resource_end_user_id
RENAME TO resource_customer_id;

--> statement-breakpoint
CREATE
OR REPLACE FUNCTION jwt_customer_id () RETURNS varchar LANGUAGE sql STABLE AS $function$
  select coalesce(
...
--> statement-breakpoint
CREATE POLICY customer_access ON public.resource TO customer USING (
...
--> statement-breakpoint
CREATE POLICY customer_access ON public.pipeline TO customer USING (
  (
    SELECT
      array(
        SELECT
...
ALTER INDEX public.pk_resource
RENAME TO pk_connection;
...
ALTER TABLE public.connection
ALTER COLUMN id
SET DEFAULT concat('conn_', public.generate_ulid ());

--> statement-breakpoint
ALTER TABLE public.connection
DROP CONSTRAINT resource_id_prefix_check;
...
SET
  default_pipe_out = CASE
    WHEN default_pipe_out ->> 'destination_id' LIKE 'reso_%' THEN jsonb_set(
      default_pipe_out,
      '{destination_id}',
      to_jsonb(REPLACE(default_pipe_out ->> 'destination_id', 'reso_', 'conn_'))
    )
    ELSE default_pipe_out
  END,
  default_pipe_in = CASE
    WHEN default_pipe_in ->> 'source_id' LIKE 'reso_%' THEN jsonb_set(
      default_pipe_in,
      '{source_id}',
      to_jsonb(REPLACE(default_pipe_in ->> 'source_id', 'reso_', 'conn_'))
    )
...
--> statement-breakpoint
ALTER TABLE public.connection
ADD CONSTRAINT connection_id_prefix_check CHECK (starts_with((id)::text, 'conn_'::text));
...
--> statement-breakpoint
-- Rename indexes
ALTER INDEX public.resource_created_at
RENAME TO connection_created_at;

--> statement-breakpoint
ALTER INDEX public.resource_customer_id
RENAME TO connection_customer_id;

--> statement-breakpoint
ALTER INDEX public.resource_provider_name
RENAME TO connection_provider_name;

--> statement-breakpoint
ALTER INDEX public.resource_updated_at
RENAME TO connection_updated_at;
...
CREATE POLICY customer_access ON public.connection TO customer USING (
...
--> statement-breakpoint
CREATE POLICY org_access ON public.connection TO org USING (
  connector_config_id IN (
    SELECT
      connector_config.id
    FROM
...
--> statement-breakpoint
CREATE POLICY org_member_access ON public.connection TO authenticated USING (
  connector_config_id IN (
    SELECT
      connector_config.id
    FROM
