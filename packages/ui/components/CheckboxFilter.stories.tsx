...
const InteractiveCheckboxFilter = ({initialCheckedState = {}}) => {
  ...
  const [checkedState, setCheckedState] = useState<Record<string, boolean>>(
    () => {
      ...
      if (
        typeof initialCheckedState === 'object' &&
  ...
  return (
    <div className="flex w-[600px] flex-col gap-4">
      ...
      <div className="rounded-md border p-4">
        <h3 className="mb-2 text-lg font-semibold">Selected Filters:</h3>
...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'A checkbox filter component with a popover that allows users to select multiple options and apply filters. This component is used in the IntegrationSearch component to filter integrations by category.',
      },
    },
  },
  tags: ['autodocs'],
...
export const Default: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Default CheckboxFilter component with category options. This example is fully interactive - you can select filters, apply them, and see the results.',
      },
    },
  },
}
...
export const WithPreselectedOptions: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'CheckboxFilter with some options pre-selected (CRM and Marketing). This example is fully interactive - you can modify the filters, apply them, and see the results.',
      },
    },
  },
}
