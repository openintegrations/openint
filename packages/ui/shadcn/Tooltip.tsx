...
>(({className, sideOffset = 4, ...props}, ref) => (
  <TooltipPrimitive.Content
    ...
    className={cn(
      'z-50 overflow-hidden rounded-md border bg-tooltip p-2 px-3 py-1.5 text-sm text-tooltip-foreground shadow-md duration-150 animate-in fade-in-0 zoom-in-95',
